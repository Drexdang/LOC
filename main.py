...
st.markdown("""
Welcome to the **Phone Number Location Finder**! This tool helps you find the general location of a phone number, including the country and the city or region where the phone number is currently in use.
...
if number:
    ...
    if results:
        ...
        p = figure(
            x_range=(wm_x - 10000, wm_x + 10000),
            y_range=(wm_y - 10000, wm_y + 10000),
